/**
 * Patch Facebook Authenticator Options Request: Used to partially update Sign in with Facebook configuration and behavior.
 * @export
 * @interface PatchFacebookAuthenticatorOptionsRequest
 */
export interface PatchFacebookAuthenticatorOptionsRequest {
  /**
   * Specifies whether users can sign in using this external identity provider.
   * @type {boolean}
   * @memberof PatchFacebookAuthenticatorOptionsRequest
   */
